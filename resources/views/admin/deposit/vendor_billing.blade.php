        ...
        <div class="content-body">
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Vendor </a></li>
                                            ...
                                            <?php if(is_array($product_list) || is_object($product_list)){ ?>
                                                ...
                                                @foreach($product_list as $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('admin.view_vendor_invoice', ['id'=> Crypt::encrypt($value->id)]) }}" class="btn btn-primary btn-sm btn-rounded" >
                                                        Generate Menu
                                                            </a></td>
