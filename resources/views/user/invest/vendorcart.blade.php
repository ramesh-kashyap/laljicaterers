        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Event Date</label>
                        <input type="date" class="form-control" id="email" name="event_date" required>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Total People</label>
                        <input type="text" class="form-control" id="phone" name="total_people" required>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Additional Enquiry</label>
                        <input type="text" class="form-control" id="phone" name="additional_inquiry" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="address" class="form-label">People taking Breakfast</label>
                        <input type="text" class="form-control" id="address" name="no_breakfast" required>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">People taking Lunch</label>
                        <input type="text" class="form-control" id="address" name="no_lunch" required>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">People taking Dinner</label>
                        <input type="text" class="form-control" id="address" name="no_dinner" required>
                    </div>
                    <div class="mb-3">
